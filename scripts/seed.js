...
// Combined function to create admin if not exists and import exercises
const setupAdminAndExercises = async () => {
  try {
    // Connect to database
    await connectDB();
    ...
    // Clear existing exercises data (optional)
    ...
    const createdExercises = await Exercise.insertMany(exercisesWithAdmin);
